	...
	if (!function_exists('landhostudio_setup')) {
      ...
      add_action( 'init', 'change_post_object_label' );
        ...
        wp_enqueue_style('all-css', get_template_directory_uri() . '/dist/css/all.css', 'all');
				wp_register_script('all-js', get_template_directory_uri() . '/dist/js/all.js', true);
						...
						array (
							'sub_fields' => array (
								array (
									...
									'default_value' => '',
									'delay' => 0,
									'key' => 'field_583f107640553',
									'label' => 'Testo',
									'name' => 'hello_column_text',
									'type' => 'wysiwyg',
									'instructions' => '',
									'required' => 0,
									'conditional_logic' => 0,
								...
								array (
									...
									'placeholder' => '',
									'return_format' => 'value',
									'key' => 'field_583f10a340554',
									'label' => 'Dimensione',
									'name' => 'hello_column_size',
									'type' => 'select',
									'instructions' => 'Layout utilizza 6 colonne di cui la media ne occupa 2',
									'required' => 0,
									'conditional_logic' => 0,
									'wrapper' => array (
										'width' => '',
